  ...
  const SKILLS = [
    {
      ...
      value: "C, C++, JavaScript, TypeScript, HTML/CSS, Python",
    },
    {
      category: "Frameworks/ Libraries",
      value:
        "Django, React.js, Next.js, Node.js, Express.js",
    },
    {
      category: "Database",
      value: "MySQL, MongoDB, NoSQL",
    },
    {
      category: "Developer Tools",
      value: "VS Code, Google Colab, Kaggle Notebook, PyCharm",
    },
  ];
  return (
