          ...
          <ul>
            <li className="mt-6 flex items-center gap-3">
              ...
              <div>
                ...
                <a
                  href="mailto:monilmehta63@gmail.com"
                  target="_blank"
                  className="text-blue-700 dark:text-blue-200"
                >
                  monilmehta63@gmail.com
                </a>
              </div>
            </li>
            <li className="mt-6 flex items-center gap-3">
            ...
            <li className="mt-6 flex items-center gap-3">
              ...
              <div>
                <span className="font-semibold">Address:</span> Mariyappana Palya, Gnana Bharathi, Bengaluru, Karnataka - 560056, India
              </div>
            </li>
          </ul>
        </div>
